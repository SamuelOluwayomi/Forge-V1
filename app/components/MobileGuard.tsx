    ...
    return (
      <div className="fixed inset-0 z-[1000] bg-[#FDF3E3] paper-texture flex flex-col items-center justify-center p-6 text-center overflow-y-auto">
        ...
        <div className="mb-8">
          ...
          />
          <div
            className="brutalist-tape text-[10px] px-3 py-1 inline-block mt-2"
        ...
        <div className="brutalist-card bg-white p-8 max-w-sm border-4 border-black relative">
          ...
          <p className="font-bold text-sm text-black/70 mb-6 leading-relaxed text-left">
            Forge is an{" "}
            <span className="text-black">onchain professional workstation</span>{" "}
            for developers. Because we use complex IDE-like dashboards,
            multi-step escrow flows, and terminal interfaces, the experience is
            optimized strictly for{" "}
            <span className="text-primary underline">laptops and desktops</span>
            .
          </p>
          ...
          <div className="bg-black/5 border-2 border-dashed border-black/20 p-4 mb-6 text-left">
            ...
            <p className="text-xs font-bold leading-snug italic">
              "A trustless developer marketplace where you earn SOL through
              escrow-secured tasks and mint Soulbound Tokens as permanent proof
              of your expertise."
            </p>
          </div>
        ...
        <div className="fixed bottom-10 left-6 -rotate-12 pointer-events-none opacity-20">
          <div className="w-24 h-24 border-4 border-black rounded-full flex items-center justify-center font-black text-4xl">
            ?
          </div>
        </div>
        <div className="fixed top-10 right-6 rotate-12 pointer-events-none opacity-20">
          <div className="w-20 h-20 border-4 border-black flex items-center justify-center font-black text-4xl">
            !
          </div>
        </div>
      </div>
