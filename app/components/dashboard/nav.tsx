...
export const ADMIN_WALLET = "HDpuuLudmQcCm52z1L8SC8eMAX8SQedum6KPu2b6TgW";
        ...
        <nav className="flex-1 p-4 flex flex-col gap-1 overflow-y-auto">
          ...
          {address?.toLowerCase() === ADMIN_WALLET.toLowerCase() && (
            <Link
              ...
              id="nav-escalated"
              onClick={() => setSidebarOpen(false)}
              className={`flex items-center gap-3 px-3 py-2.5 font-black text-sm uppercase tracking-wide border-2 transition-all duration-100 mt-2
                ${isActive("/dashboard/escalated")
                  ? "bg-[#FF4500] text-white border-[#FF4500] shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
                  : "bg-[#FF4500]/10 text-[#FF4500] border-transparent hover:border-[#FF4500] hover:bg-[#FF4500] hover:text-white hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
                }`}
            >
              <span className={isActive("/dashboard/escalated") ? "text-white" : "text-[#FF4500] group-hover:text-white"}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="square">
